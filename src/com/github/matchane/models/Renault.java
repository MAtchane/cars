...
/**
 * Class representing Renault car models
 */
public class Renault {
    private static String MANUFACTURER = "Renault";
     ...
     */
    public Renault(String modelId, int year, String engine, String transmission, int doors) {
